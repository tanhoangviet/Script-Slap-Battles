...
loadstring(game:HttpGet("https://raw.githubusercontent.com/tanhoangviet/Script-Slap-Battles/main/AmongUs-X-GiangMc-Hub.lua"))()
    ]])
else
...
local Window = OrionLib:MakeWindow({IntroText = "Slap Battles 👏", IntroIcon = "rbxassetid://15315284749",Name = ('<font color="#FF0000">AmongUs ඞ</font> × Giang Hub - Slap Battles 👏'.." | ".. identifyexecutor()),IntroToggleIcon = "rbxassetid://7734091286", HidePremium = false, SaveConfig = false, IntroEnabled = true, ConfigFolder = "slap battles"})
...
game.Players.LocalPlayer.Character:FindFirstChild("Squid")
end
...
HideHit = Tab16:AddToggle({
	Name = "Hide Hit Effect",
	Default = false,
	Callback = function(Value)
_G.Hide = Value
if hookmetamethod then
...
oldIndex = hookmetamethod(game, "__index", function(self, key)
    if _G.Hide and key == "_hitEffectDefault" then
        return nil
    end
